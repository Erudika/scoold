...
public class CustomLinkAvatarRepositoryTest {
	...
	public void setUp(){
		...
		this.repository = new CustomLinkAvatarRepository(gravatarGenerator, defaultRepository);
	}
	...
	public void getAnonymizedLink_should_use_default_repository() {
		...
		AvatarRepository repository = new CustomLinkAvatarRepository(gravatarGenerator, defaultRepository);
