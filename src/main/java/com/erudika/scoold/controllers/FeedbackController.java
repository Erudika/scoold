...
//
//	public void onGet() {
//		String feedbackType = Utils.type(com.erudika.scoold.core.FeedbackController.class);
//
//		if (param("tag")) {
...
//
//	public void onPost() {
//		Post post = populate(new com.erudika.scoold.core.FeedbackController(), "title", "body", "tags|,");
//		error = validate(post);
//		if (error.isEmpty()) {
//			post.create();
