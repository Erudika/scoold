...
public class QuestionsController {
	...
	@PostMapping(path = "/questions/render-markdown", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
	public String renderMarkdown(@RequestParam String md, HttpServletRequest req, HttpServletResponse res) {
		if (utils.isAjaxRequest(req)) {
