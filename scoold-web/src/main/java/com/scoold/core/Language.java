...
//			.put(User.Badge.TEACHER.toString(), "Teacher")
	...
	//		.put("settings.importphotos", "Import your photos")
			...
			.put("about.scoold.1", "Scoold is a student network for knowledge sharing and collaboration. Its primary goal is to help students find the answers to all questions related to their education. But it's not just for students — teachers and former students are welcome, too! Everyone can ask a question about anything related to the education process. For example, students can ask questions about their coursework, teachers can answer them, and former students can share their knowledge and experience with everyone else.")
			.put("about.scoold.2", "Information is organized around questions. Questions can be specific or they can be in the form of a discussion on a certain topic. Every question can have one or more answers or replies which are sorted by votes. Votes indicate the quality of answers but this also applies to questions. In fact, everything posted on Scoold can be voted up or down.")
			.put("about.scoold.3", "Scoold has been greatly influenced by the sites of the Stack Exchange family and we have huge respect towards the guys behind them. We wanted to create a website based on that clever Q&A model but targeted towards a broader audience, namely students and teachers.")
			.put("about.scoold.4", "In general, Scoold is all about:")
			.put("about.scoold.5", "learning new stuff,")
			.put("about.scoold.6", "sharing knowledge,")
			.put("about.scoold.7", "gathering and organizing information,")
			.put("about.scoold.8", "helping your mates and earning reputation while doing it.")
			...
			.put("about.questions.2", "coursework and homework,")
			...
			.put("about.questions.7", "internal school matters like timetables, graduation and other events.")
			.put("about.questions.8", "Questions are linked to schools, so you need to join at least one school to ask a question. This way you can more easily find the information that's relevant to your school and interests.")
			.put("about.questions.9", "You can, of course, always answer you own question if you know the answer to it. This way you helping others and you can earn some reputation, as well. You can also ask as many questions as you want, as long as they don't exist already for a particular school. Duplicate questions might get voted down or deleted.")
			.put("about.questions.10", "Anything related to Scoold itself should be asked/discussed in the feedback section of the site. There you can post all your site-related questions, suggestions, general feedback or feature requests.")
			.put("about.questions.11", "Some questions might be closed for various reasons — too many answers, duplication or it's just inappropriate. This only means that no new answers can be posted and does not affect editing. A question is automatically marked for closing when it reaches -5 votes.")
			.put("about.questions.12", "Questions can be edited by everyone with the 'Teacher' badge.")
			
			.put("about.answers.1", "Answers can be posted to any question that hasn't been closed yet. The good answers are always at the top but only one can be accepted as the best by the author of the question. The accepted answer should be the one that's most helpful, rather than the one with the most votes. You should avoid posting answers that are one or two words long — these should be posted as comments instead (see Comments below).")
			.put("about.answers.2", "Everyone with the 'Freshman' badge can edit an answer.")

			.put("about.revisions.1", "Every time you edit a question or an answer, a new revision is created. Revisions keep track of all the changes in the text, title and tags of questions and answers. The first revision is the original and it is created automatically. When you edit the original, revision number #1 is created, followed by #2 and so on.")
			.put("about.revisions.2", "You can always switch back to the original or to a previous revision. Restoring back to the original does not delete any of the revisions — this just creates a new revision with the original text restored.")
			
			.put("about.comments.1", "Comments can be posted on all questions, answers. A comment is basically any text that is too short for an answer or is just off-topic. Comments can also contain suggestions or criticism. Bad comments will be voted down and hidden when they reach -5 votes.")
			.put("about.comments.2", "Everyone with the 'Enthusiast' badge can post comments.")
			
			.put("about.schools.1", "You can create school pages for any kind of school or university that exists around the world. A school can contain many classes and is open for everyone to join. On each school page you can write a brief description and contact information for that school.")
			...
			.put("about.voterep.1", "Voting is an integral part of Scoold. If you like something useful or interesting, vote it up. Questions that are clear and well-written should also be given a +1. The same goes for answers that are helpful. If something is poorly written, unclear, off-topic or inappropriate, vote it down.")
			.put("about.voterep.2", "Your reputation points measure how much other people trust you and liked you. Reputation is earned by posting good questions and answers. It is also awarded with certain badges (see Badges).")
			.put("about.voterep.3", "Voting is linked to reputation. You earn reputation points when your post gets voted up and you lose points if your post gets voted down. Voting down will cost you 1 reputation point.")
			...
			.put("about.voterep.10", "If you voted something down you loose:")
			...
			.put("about.badges.18", "your question got +20 votes")
			.put("about.badges.19", "your answer got +10 votes")
			.put("about.badges.20", "every time you answer your own question")
			.put("about.badges.21", "your account is 1 year old")
			...
			.put("about.reports.1", "If you notice any problems on Scoold, you should report them. This includes bugs, missing or incorrect information, abusive, discriminatory, or exploitative behavior. Every report you send help us keep the site a nice and friendly place! ")
			
			.put("about.accounts.1", "You don't sign up for an account at Scoold — you simply sign in. You can sign in with your account at Facebook, Google, Yahoo, AOL or any other account that is compatible with OpenID. When you first sign in, we'll ask you for your name and email. We promise to keep your email safe and never send you anything, unless it's really important.")
			
			.put("about.feedback.1", "The feedback section is where you can tell us what you think about the site. You can also ask anything about the site itself, describe in details any problems you've encountered or suggest an improvement. So if you think there's something we've missed, go there now and tell us!")
